 ...
 */
public abstract class DataBoundRvAdapter_old<T, V extends ViewDataBinding>
  ...
  public void replaceWithDiffUtil(List<T> listToUpdate) {
    Timber.d("DataBoundRvAdapter:replaceWithDiffUtil: ");
    dataVersion++;
    ...
    if (list == null) {
      ...
      new AsyncTask<Void, Void, DiffResult>() {
        ...
        protected DiffResult doInBackground(Void... voids) {
          return DiffUtil.calculateDiff(new DiffUtil.Callback() {
            ...
            public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
              ...
              return DataBoundRvAdapter_old.this.areItemsTheSame(oldItem, newItem);
            }
            ...
            public boolean areContentsTheSame(int oldItemPosition, int newItemPosition) {
              T oldItem = oldList.get(oldItemPosition);
              T newItem = listToUpdate.get(newItemPosition);
              return DataBoundRvAdapter_old.this.areContentsTheSame(oldItem, newItem);
            }
          });
        }
        ...
        protected void onPostExecute(DiffResult diffResult) {
          ...
          list = listToUpdate;
          diffResult.dispatchUpdatesTo(DataBoundRvAdapter_old.this);
        }
      }.execute();
    }
  }
  ...
  /////////////////////////  ViewHolder  ///////////////////////
  public static class RemarkRvViewHolder extends RecyclerView.ViewHolder {

    private ViewDataBinding binding;


    public RemarkRvViewHolder(View itemView) {
      super(itemView);
